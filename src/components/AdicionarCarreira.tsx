...
export default function AdicionarCarreira({ isOpen, onClose, onSave, type, registeredClubs = [], editData = null }: Props) {
  ...
  }, [isOpen, editData, registeredClubs, type]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (type === 'experience') {
      ...
      const achievement: Achievement = {
        ...
        year: formData.year,
        club: formData.club,
        type: formData.achievementType as 'Coletivo' | 'Individual',
        placement: formData.achievementType === 'Coletivo' ? formData.placement as any : undefined,
