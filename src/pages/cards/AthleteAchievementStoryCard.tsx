...
/* =========================
   COMPONENT
========================== */
export default function AthleteAchievementStoryCard({
  athleteName,
  profilePhotoUrl,
  title,
  achievement,
  ...
  return (
    ...
    >
      {/* Moldura externa */}
      <div className="absolute inset-0 rounded-[40px] border-[3px] border-yellow-500" />
      ...
      <div className="relative h-1/2 p-6 flex flex-col justify-between">
        ...
        <div className="relative z-10 text-center space-y-3">
          ...
          {/* Achievement */}
          <div className="text-yellow-600 text-sm font-bold uppercase tracking-widest">
            {achievement}
          </div>

          {/* Competição */}
          <div className="text-gray-900 text-xl font-extrabold leading-tight px-2">
            {title}
          </div>
          ...
          {/* Clube */}
          <div className="bg-white/90 rounded-xl px-4 py-2 border border-gray-300 text-gray-900 font-bold">
            {club}
          </div>
        </div>
